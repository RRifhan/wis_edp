					...
					<form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
						<div class="input-group">
							...
							<datalist id="listMenu">
								...
								$menu = $db->query("SELECT tb_menu.*,id_level_user FROM tb_menu JOIN tb_menu_role ON tb_menu.id=tb_menu_role.id_menu WHERE id_level_user='$role_id' AND link!='#' ORDER BY urutan_menu")->getResult();
